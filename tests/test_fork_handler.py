...
from orchestrator import handle_fork_transition
...
class TestForkHandler:
    ...
    @pytest.mark.asyncio
    async def test_fork_handler_creates_new_agent_in_agents_array(self, tmp_path):
        ...
        updated_agent, new_agent = await handle_fork_transition(agent, transition, state, None)
    ...
    @pytest.mark.asyncio
    async def test_new_agent_has_unique_id(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_new_agent_has_empty_return_stack(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_new_agent_has_session_id_none(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_new_agent_current_state_is_fork_target(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_parent_agent_continues_at_next_state(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_fork_attributes_available_as_template_variables(self, tmp_path):
